...
app.config.update({"DEBUG": True,  # XXX: it must be False used on production server.
                   ...
                   "CATEGORIES": {
                       ...
                       "11_education": "教育", "12_kids": "キッズ & ファミリー", "13_toy": "トイ", "14_digital": "デジタルファブリケーション", "15_3d": "3Dプリンター",
                       "16_laser": "レーザーカッター", "17_cnc": "CNC、その他の工作機械", "18_software": "デジタルファブリケーションのためのソフトウェア（3D CADなど）", "19_fablab": "FabLab／Makerスペース／Makerのためのサービスなど", "20_art": "アート／デザイン",
                       "21_craft": "クラフト（木工／ペーパークラフト／電子手芸など）", "22_fashion": "ファッション", "23_music": "ミュージック／サウンド", "24_mobility": "モビリティ（電気自動車／自転車など）", "25_science": "サイエンス",
                       "26_space": "宇宙（ロケット／人工衛星など）", "27_bio": "バイオ", "28_agriculture": "農業（狩猟も含む）", "29_food": "食品 *食品を出展される方は必ずこのカテゴリを選択してください。", "30_alternative": "オルタナティブエネルギー",
                       "31_sport": "スポーツ", "32_handson": "ハンズオン（ミニワークショップ）", "33_pro": "Maker Pro（Makerとしての起業／スタートアップ）", "34_company": "企業内の部活動（業務外での作品製作）", "35_province": "地方（首都圏以外）からの出展"
                   },
